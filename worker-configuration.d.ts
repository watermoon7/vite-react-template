/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8a6b5abbaa70d5e70965a7d1e11681c5)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "KanbanStore";
	}
	interface Env {
		MUSIC: R2Bucket;
		SESSION_SECRET: string;
		PASSWORD_WILL: string;
		PASSWORD_THEO: string;
		KANBAN: DurableObjectNamespace<import("./src/worker/index").KanbanStore>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_SECRET" | "PASSWORD_WILL" | "PASSWORD_THEO">> {}
}
